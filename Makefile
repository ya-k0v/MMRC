...
logs-server: ## Show server logs
	docker compose logs -f mmrc-server

logs-optimizer: ## Show optimizer logs
	docker compose logs -f mmrc-optimizer

logs-streamer: ## Show streamer logs
	docker compose logs -f mmrc-streamer

restart: ## Restart all services
	docker compose restart

restart-server: ## Restart server
	docker compose restart mmrc-server
...
shell-server: ## Open shell in server container
	docker compose exec mmrc-server /bin/sh

shell-optimizer: ## Open shell in optimizer container
	docker compose exec mmrc-optimizer /bin/sh

shell-streamer: ## Open shell in streamer container
	docker compose exec mmrc-streamer /bin/sh
...
migrate: ## Run database migrations
	docker compose exec mmrc-server npm run migrate-db
